...
| Command       | What it does                                                                         | Reach for it when                                                                                                                                               |
| ------------- | ------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `catalogue`   | Says what each service in this stack is for, and what became of any it dropped       | Nineteen names convey nothing on their own and you want a sentence for each: what it does for you, what you lose while it is down, and how much that costs      |
...
| Command  | What it does                                                                   | Reach for it when                                                                                                                                                                                                        |
| -------- | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `plugin` | Reads what a plugin may claim, where it may contribute, and how one is written | You are writing a plugin rather than running a stack. `capabilities`, `extension-points` and `schema` print the documents this build publishes; `claims` reads a manifest on a path and says what this build makes of it |

Everything under this word is a read. It answers with no network, no catalogue
and no stack running, and each answer says which generation it is reporting — so
an author comparing two of them can tell whether the difference is their build or
their manifest. Nothing here installs a plugin: that is
[F6](/spec/10-functional/features/f-extensibility/f6-plugin-lifecycle/), and it
is not built yet.
